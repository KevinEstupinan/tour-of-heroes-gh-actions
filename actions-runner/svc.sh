...
SVC_NAME="actions.runner.KevinEstupinan-tour-of-heroes-gh-actions.debian.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (KevinEstupinan-tour-of-heroes-gh-actions.debian)"
